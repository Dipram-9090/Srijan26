...
function ResetPassword() {
    ...
    return (
        <div className="flex flex-col items-center justify-center gap-8 h-full min-h-[80vh]">
            ...
            <div className="flex flex-col items-center gap-2 relative w-4/5 sm:w-1/3 2xl:w-1/4">
            ...
            <div className="flex flex-col items-center gap-2 w-full">
                <input
                    ...
                    className="px-5 py-3 border border-yellow/70 rounded-full outline-none w-4/5 sm:w-1/3 2xl:w-1/4"
                />
